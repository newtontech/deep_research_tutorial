...
def main():
    ...
    db.load_table_from_csv("database_server/paper_metadata.csv", "paper_metadata")
    db.load_table_from_csv("database_server/paper_text.csv", "paper_text")
    db.load_table_from_csv("database_server/paper_figure.csv", "paper_figure")
    db.load_table_from_csv("database_server/molecures.csv", "molecures")
    db.load_table_from_csv("database_server/solutions.csv", "solutions")
    db.load_table_from_csv("database_server/performance.csv", "performance")
